...
class prepareResultCallable implements Callable<KcodeQuestion.res> {
    public KcodeQuestion.res res_1=new KcodeQuestion.res();
    ...
    @Override
    public KcodeQuestion.res call() throws Exception {
        this.prepareResult();
        return this.res_1;
    }
