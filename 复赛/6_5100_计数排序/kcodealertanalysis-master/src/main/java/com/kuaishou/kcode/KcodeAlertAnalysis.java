...
public interface KcodeAlertAnalysis {
     ...
     */
    Collection<String> alarmMonitor(String path, Collection<String> alertRules) throws IOException, ParseException;
     ...
     */
    Collection<String> getLongestPath(String caller, String responder, String time, String type) throws ParseException;
}