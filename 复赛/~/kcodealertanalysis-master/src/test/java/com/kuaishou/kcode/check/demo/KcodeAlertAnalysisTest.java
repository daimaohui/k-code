...
public class KcodeAlertAnalysisTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sourceFilePath1 = "C:\\Users\\daimaohui\\Downloads\\KcodeAlertAnalysis-data-test\\test\\kcodeAlertForStudent-test.data";
        // ruleForStudent-1，报警规则
        String ruleFilePath1 = "C:\\Users\\daimaohui\\Downloads\\KcodeAlertAnalysis-data-test\\test\\ruleForStudent-test.txt";
        // Q1Result-1.txt，第一问结果
        String q1ResultFilePath1 = "C:\\Users\\daimaohui\\Downloads\\KcodeAlertAnalysis-data-test\\test\\Q1Result-test.data";
        // Q2Result-1.txt，第二问输出和结果
        String q2ResultFilePath1 = "C:\\Users\\daimaohui\\Downloads\\KcodeAlertAnalysis-data-test\\test\\Q2Answer-test.data";

        // 第二套数据集
        //kcodeAlertForStudent-2.data，原始监控数据
        String sourceFilePath2 = "C:\\Users\\daimaohui\\Downloads\\data2\\kcodeAlertForStudent-2.data";
        // ruleForStudent-2，报警规则
        String ruleFilePath2 = "C:\\Users\\daimaohui\\Downloads\\data2\\ruleForStudent-2.txt";
        // Q1Result-2.txt，第一问结果
        String q1ResultFilePath2 = "C:\\Users\\daimaohui\\Downloads\\data2\\Q1Result-2.txt";
        // Q2Result-2.txt，第二问输出和结果
        String q2ResultFilePath2 = "C:\\Users\\daimaohui\\Downloads\\data2\\Q2Result-2.txt";
    ...
    public static void testQuestion12(String sourceFilePath, String ruleFilePath, String q1ResultFilePath, String q2ResultFilePath) throws Exception {
        ...
        if (Objects.isNull(alertResult) || alertResult.size() != q1CheckResult.size()) {
            System.out.println("Q1 Error Size:" + "," + q1CheckResult.size());
...
//            for(String e:longestPaths){
//                System.out.println(e);
//            }
//            for(Q2Result e:checkResult){
