...
public class KcodeAlertAnalysisImpl implements KcodeAlertAnalysis {
    ...
    public Collection<String> alarmMonitor(String path, Collection<String> alertRules) throws IOException{
        ...
        while(mapOffset<fileSize) {
            ...
            while (offset < mapSize) {
                ...
                callerIP = String.valueOf(callerIP_char,3,callerIP_char_size-3);
                ...
                responderIP = String.valueOf(responderIP_char,3,responderIP_char_size-3);
    ...
    public Collection<String> getLongestPath(String caller, String responder, String time, String type) {
        ...
        return answer.LongestPathMap[answer.find_index_1(caller)][answer.find_index_2(responder)][answer.find(time)*2+type_index];
    }
}