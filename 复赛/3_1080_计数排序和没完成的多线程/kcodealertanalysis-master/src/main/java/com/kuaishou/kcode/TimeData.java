...
public class TimeData {
    ...
    public void addPairData( int startTime,String caller, String callerIP, String responder, String responderIP,
        ...
        if(pairData.midnums==0){
            pairData.midnums=elapsedTime;
            int index=pairData.maxsize/2+elapsedTime-pairData.midnums;
            pairData.elapsedTimes[index][0]=elapsedTime; /* 耗时 */
            pairData.elapsedTimes[index][1]=1;
     ...
     * 计算结果，保存在当前的一分钟里面
     */
    public void getresult( Map<String,HashMap<String, HashMap<Integer,SRAndP99>>> Node_f,Map<String,HashMap<String, HashMap<Integer,SRAndP99>>> Node_s){
        /* 将所有set转换为数组 */
        ...
        for(String mp:callerAndresponderArray){
             ...
             * 向前图
             */
            HashMap<String, HashMap<Integer,SRAndP99>> SRAndP99Map=Node_f.computeIfAbsent(pairDataV2.caller,k->new HashMap<>());
            HashMap<Integer,SRAndP99> SRAndP99MapV1=SRAndP99Map.computeIfAbsent(pairDataV2.responder,k->new HashMap<>());
            SRAndP99MapV1.put(pairDataV2.startTime,srAndP99);
            /**
             * 向后图
             */
            HashMap<String, HashMap<Integer,SRAndP99>> SRAndP99Map1=Node_s.computeIfAbsent(pairDataV2.responder,k->new HashMap<>());
            HashMap<Integer,SRAndP99> SRAndP99Map1V1=SRAndP99Map1.computeIfAbsent(pairDataV2.caller,k->new HashMap<>());
